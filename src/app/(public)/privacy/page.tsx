  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
        <p>
          This Privacy Policy explains how Rosterly (&quot;we&quot;, &quot;us&quot;, or
          &quot;our&quot;) collects and uses personal information through our services and websites.
          Personal information means information about an identifiable individual.
        </p>

        <p>
          This Privacy Policy applies globally, but we have included additional information below
          for residents of the European Economic Area, the United Kingdom, Switzerland, and
          California.
        </p>

        <p>This Privacy Policy does not apply to de-identified or anonymous information.</p>

        <Section title="1. What information do we collect and why?">
          <Subsection title="When you create an account as an athlete">
            <p>
              We collect your name, email address, school, graduation year, sport, position, height,
              weight, bio, and performance statistics. We collect this to build your athlete profile
              and share it with prospective university recruiters.
            </p>
          </Subsection>
          ...
          <Subsection title="When you use our platform">
            <p>
              ...
              features used, and actions taken. We use this to improve our platform and provide a
              better experience.
            </p>
          </Subsection>
          ...
          <Subsection title="Authentication">
            <p>
              ...
              security. Clerk may collect additional information as described in their privacy
              policy.
            </p>
          </Subsection>
        </Section>
        ...
        <Section title="2. When and why do we share personal information?">
          ...
          <Subsection title="Service providers">
            <p>
              We share information with third-party service providers who perform functions on our
              behalf, such as hosting, authentication, and analytics.
            </p>
          </Subsection>

          <Subsection title="Legal requirements">
            <p>
              We may share information with regulators, authorities, and enforcement agencies where
              we are under a legal duty to disclose your personal data or to protect our rights,
              property, and safety.
            </p>
          </Subsection>
          ...
          <Subsection title="Business transfers">
            <p>
              ...
              in which case your information may be transferred to the acquiring entity.
            </p>
          </Subsection>
        </Section>
        ...
        <Section title="3. How do we keep your personal information secure?">
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>Access control:</strong> Authentication and least-privilege access
            </li>
            <li>
              <strong>Protected servers:</strong> Data stored on servers not publicly accessible
            </li>
            <li>
              <strong>Audit logging:</strong> All data changes are logged for accountability
            </li>
          </ul>
          <p>
        ...
        <Section title="4. Where do we store your personal information?">
          <p>
            Rosterly stores your data in the United States. Some of our service providers may be
            based outside of your jurisdiction. When we transfer your personal information, we
            ensure it receives appropriate protection as required by law.
          </p>
        </Section>
        ...
        <Section title="5. How long do we keep your personal information?">
          <p>
            ...
            services. After account deletion, we may retain certain information as required by law
            or for legitimate business purposes. We may use anonymized information indefinitely to
        ...
        <Section title="6. What are my rights?">
          <Subsection title="Access and correction">
            <p>
              You can access and update your profile information through your account settings. To
              request a copy of all personal information we hold about you, contact us.
            </p>
          </Subsection>

          <Subsection title="Deletion">
            <p>
              You can request deletion of your account and associated data by contacting us. Some
        ...
        <Section title="7. Additional rights for European residents">
          <p>In addition to the rights above, European residents may also be entitled to:</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>Restrict processing:</strong> Request that we limit or cease processing your
              information
            </li>
            <li>
            ...
            <li>
              <strong>Object:</strong> Object to how we are using your personal information
            </li>
            <li>
              <strong>Withdraw consent:</strong> Withdraw consent to our handling of your personal
              information
            </li>
          </ul>
        </Section>
        ...
        <Section title="8. Additional rights for California residents">
          <p>If you are a California resident, you can:</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>Request what personal information we have about you</li>
            <li>Request deletion of your personal information</li>
            <li>
              Request that we stop selling your personal information (we do not sell personal
              information)
            </li>
          </ul>
        </Section>
